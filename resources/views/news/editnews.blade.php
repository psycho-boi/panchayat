    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
        <form id="edit-news-form" method="POST" action="{{ route('news.update', $news->news_id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control "  name="news_title" value="{{ $news->title  }}" required autocomplete="name" autofocus>
                </div>
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-6">
                    <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="news_content" required>{{ $news->description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="images" type="file" class="form-control-file" name="news_photos[]" multiple >
                    <ul id="image-list"></u>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="photo-section col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="photo-item position-relative">
                            <img src="{{ asset(str_replace('public/', 'storage/', $image->url)) }}" alt="news Photo" class="img-thumbnail">
