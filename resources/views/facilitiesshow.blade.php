    ...
    <div class="facilities-details ">
        ...
        <div class="facilities-details">
            ...
            <div class="row justify-content-center align-items-center text-center">
                <div class="col-12">
                    <img src="{{ asset( $mainImage->url) }}" alt="Main Image" style="width: 100%">
                </div>
            </div>
            @endif
            ...
            <div class="row">
                <div class="col">
                    <h2 class="sub-heading">{{ $facilitiesItem->title }}</h2>
                    <p class="">{{ $facilitiesItem->description }}</p>
                </div>
            </div>
            ...
            <div class="related-images">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <img src="{{ asset(  $image->url) }}" alt="Related Image" class="img-fluid mb-3">
                    </div>
                    @endforeach
                </div>
            </div>
