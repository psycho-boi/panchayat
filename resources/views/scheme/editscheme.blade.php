...
<div class="container pt-4 ">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
        <form id="edit-scheme-form" method="POST" action="{{ route('scheme.update', $scheme->scheme_id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control "  name="scheme_title" value="{{ $scheme->title  }}" required autocomplete="name" autofocus>
                </div>
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-6">
                    <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="scheme_content" required>{{ $scheme->description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="Eligibility" class="form-control @error('address') is-invalid @enderror" name="scheme_eligibility" required>{{ $scheme->eligibility }}</textarea>
            ...
            <div class="form-group row pt-4">
                ...
                <div class="col-md-6">
                    <input id="images" type="file" class="form-control-file" name="scheme_photos[]" multiple >
                    <ul id="image-list"></u>
                </div>
            </div>
            ...
            <div class="form-group row">
               ...
               <div class="col-md-6">
                   <input id="pdfs" type="file" class="form-control-file " name="scheme_doc[]" multiple accept="application/pdf">
               </div>
    ...
    <div class="container">
            <div id="photos-container" class="py-5 my-5">
                ...
                <div class="row">
                    @foreach ($schemeImages as $image)
                    <div class="photo-section col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="photo-item position-relative">
                            <img src="{{ asset(str_replace('public/', 'storage/', $image->url)) }}" alt="scheme Photo" class="img-thumbnail">
