    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
        <form id="edit-slider-form" method="POST" action="{{ route('slider.update', $slider->slider_id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control "  name="slider_title" value="{{ $slider->title  }}" required autocomplete="name" autofocus>
                </div>
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-6">
                    <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="slider_content" required>{{ $slider->description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="images" type="file" class="form-control-file" name="slider_photos" multiple >
                    <ul id="image-list"></u>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="photo-section col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="photo-item position-relative">
                            <img src="{{ asset(str_replace('public/', 'storage/', $image->url)) }}" alt="slider Photo" class="img-thumbnail">
