                    ...
                    @foreach ($eventItem as $event)
                     <tr>
                        ...
                        <td>        
                            ...
                            {{-- single image --}}
                            @if($event->image_url)
                            <img src="{{asset('storage/'. $event->image_url)}}" alt="no image found">
                            @else
                            No Image
                            @endif
                        ...
                        <td>
                            @if ($event->event_doc_url)
                                <a href="{{ route('event.doc', ['event_doc_url' => $event->event_doc_url]) }}" class="btn btn-primary" target="_blank">View Document</a>
                            @else
                                No Document
                            @endif
                        </td>
